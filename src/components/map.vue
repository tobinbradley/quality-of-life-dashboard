  ...
  methods: {
    ...
    initMapEvents: function() {
      ...
      map.on("click", function(e) {
        ...
        let featureIndex = _this.sharedState.selected.indexOf(
    ...
    zoomNeighborhoods: function() {
      ...
      this.privateState.geoJSON.features.forEach(function(feature) {
        if (
          _this.sharedState.zoomNeighborhoods.indexOf(feature.properties.id) !==
          -1
        ) {
        ...
        features: [
          {
            ...
            geometry: {
              type: "Point",
              coordinates: [
                this.sharedState.marker.lng,
                this.sharedState.marker.lat
              ]
            },
            properties: {
